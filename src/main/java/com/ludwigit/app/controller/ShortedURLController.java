...
public class ShortedURLController {
	...
	public ResponseEntity<String> retrieveUrl(@PathVariable String shortenUrl) throws URISyntaxException {
	...
	public ResponseEntity<String> shortUrl(@RequestBody CreateShortURLRequestBody body) {
